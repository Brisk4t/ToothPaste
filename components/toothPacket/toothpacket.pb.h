...
#ifndef PB_TOOTHPASTE_SHARED_TOOTHPACKET_PB_H_INCLUDED
#define PB_TOOTHPASTE_SHARED_TOOTHPACKET_PB_H_INCLUDED
#include <pb.h>
...
#define TOOTHPASTE_SHARED_TOOTHPACKET_PB_H_MAX_SIZE toothpaste_EncryptedData_size
